var CustomImportScript = (() => {
  ...
  // tools/importer/import-model-detail.js
  var import_model_detail_exports = {};
  __export(import_model_detail_exports, {
    default: () => import_model_detail_default
  });
  ...
  var PAGE_TEMPLATE = {
    "name": "model-detail",
    "urls": [
      "https://www.volkswagen.de/de/modelle/id-7-gtx.html"
    ],
    "description": "Model detail page with hero, product carousel, mood gallery, specs grid, and configuration CTAs",
    "blocks": [
      {
        "name": "hero-stage",
        "instances": [
  ...
  var import_model_detail_default = {
    transform: (payload) => {
  ...
  return __toCommonJS(import_model_detail_exports);
})();
